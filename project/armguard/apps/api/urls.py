...
urlpatterns = [
    ...
    # SYNC: Desktop ↔ server data synchronisation endpoints.
    path('sync/pull/',  SyncPullView.as_view(),  name='api-sync-pull'),
    path('sync/push/',  SyncPushView.as_view(),  name='api-sync-push'),
]
